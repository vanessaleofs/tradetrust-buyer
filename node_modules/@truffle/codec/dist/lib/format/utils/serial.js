    ...
    switch (dataType.typeClass) {
        ...
        case "type":
            if (dataType.stateVariableTypes !== undefined) {
                return Object.assign(Object.assign({}, dataType), { stateVariableTypes: dataType.stateVariableTypes.map(({ name, type: stateVariableType }) => ({
                        name,
                        type: serializeType(stateVariableType)
                    })) });
            }
            else {
                return dataType; //fricking TypeScript
            }
        default:
            return dataType;
    }
