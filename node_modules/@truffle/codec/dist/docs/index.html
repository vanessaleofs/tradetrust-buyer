		...
		<div class="col-8 col-content">
			<div class="tsd-panel tsd-typography">
				...
				<ul>
					...
					<li><p>You can only decode storage variables in full mode. If full mode fails
						while decoding a storage variable, it will throw an exception.</p>
					</li>
