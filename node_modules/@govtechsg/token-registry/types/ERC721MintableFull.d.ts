...
interface ERC721MintableFullInterface extends Interface {
  functions: {
    ...
    safeMint: TypedFunctionDescription<{
      encode([to, tokenId, _data]: [string, BigNumberish, Arrayish]): string;
    }>;
...
export class ERC721MintableFull extends Contract {
  connect(signerOrProvider: Signer | Provider | string): ERC721MintableFull;
  attach(addressOrName: string): ERC721MintableFull;
  deployed(): Promise<ERC721MintableFull>;

  on(event: EventFilter | string, listener: Listener): ERC721MintableFull;
  once(event: EventFilter | string, listener: Listener): ERC721MintableFull;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): ERC721MintableFull;
  removeAllListeners(eventName: EventFilter | string): ERC721MintableFull;
  removeListener(eventName: any, listener: Listener): ERC721MintableFull;
  ...
  estimate: {
    ...
    mint(to: string, tokenId: BigNumberish): Promise<BigNumber>;
