(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash'), require('js-sha3'), require('flatley'), require('ajv'), require('debug'), require('validator'), require('uuid'), require('verbal-expressions'), require('ethers')) :
	typeof define === 'function' && define.amd ? define(['exports', 'lodash', 'js-sha3', 'flatley', 'ajv', 'debug', 'validator', 'uuid', 'verbal-expressions', 'ethers'], factory) :
	(global = global || self, factory(global.openAttestation = {}, global.lodash, global.jsSha3, global.flatley, global.ajv, global.debug, global.validator, global.uuid, global.verbalExpressions, global.ethers));
}(this, (function (exports, lodash, jsSha3, flatley, ajv, debug, validator, uuid, verbalExpressions, ethers) { 'use strict';
	...
	exports.isSignedWrappedV2Document = function (document) {
	    return document.proof && exports.isWrappedV2Document(document);
	};
	...
	var utils_10 = utils.isSignedWrappedV2Document;
	var utils_11 = utils.getIssuerAddress;
	var utils_12 = utils.keccak256;
	...
	exports.validateSchema = function (document, validator) {
	    ...
	    var valid = validator(utils$1.getData(document));
	    if (!valid) {
	...
	(function (AttachmentType) {
	    ...
	    AttachmentType["ApplicationVndOpenxmlformatsOfficedocumentSpreadsheetmlSheet"] = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
	    AttachmentType["ApplicationVndOpenxmlformatsOfficedocumentWordprocessingmlDocument"] = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
	...
	exports.__unsafe__mapToW3cVc = function (document) {
	    var _a = utils$1.getData(document), proof = _a.proof, issuer = _a.issuer, attachments = _a.attachments, type = _a.type, validFrom = _a.validFrom, validUntil = _a.validUntil, context = _a["@context"], rest = __rest(_a, ["proof", "issuer", "attachments", "type", "validFrom", "validUntil", "@context"]);
	...
	exports.obfuscateDocument = privacy$1.obfuscateDocument;
	...
	var cjs_9 = cjs.obfuscateDocument;
	var cjs_10 = cjs.sign;
	...
	exports.obfuscateDocument = cjs_9;
	exports.sign = cjs_10;
	exports.utils = cjs_1;
	exports.v2 = cjs_2;
	exports.v3 = cjs_3;
