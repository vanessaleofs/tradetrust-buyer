...
export var __unsafe__mapToW3cVc = function (document) {
    var _a = getData(document), proof = _a.proof, issuer = _a.issuer, attachments = _a.attachments, type = _a.type, validFrom = _a.validFrom, validUntil = _a.validUntil, context = _a["@context"], rest = __rest(_a, ["proof", "issuer", "attachments", "type", "validFrom", "validUntil", "@context"]);
