...
import { getData, v3 } from "@govtechsg/open-attestation";
import { isWrappedV3Document } from "../../types/core";
import { OpenAttestationEthereumTokenRegistryMintedCode } from "../../types/error";
import { createTokenRegistryContract, getIssuersTokenRegistry, isMintedOnTokenRegistry } from "../../common/smartContract/tokenRegistryContractInterface";
...
export var openAttestationEthereumTokenRegistryMinted = {
    skip: function () {
        return Promise.resolve({
            ...
            reason: {
                ...
                codeString: OpenAttestationEthereumTokenRegistryMintedCode[OpenAttestationEthereumTokenRegistryMintedCode.SKIPPED],
                    ...
                    return [4 /*yield*/, Promise.all(tokenRegistries.map(function (tokenRegistry) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        contract = createTokenRegistryContract(tokenRegistry, options);
                                        return [4 /*yield*/, isMintedOnTokenRegistry(contract, merkleRoot_1)];
                                    case 1:
                                        minted = _a.sent();
                                        status = {
                                            minted: minted,
                ...
                case 2:
                    ...
                    return [2 /*return*/, {
                            ...
                            reason: {
                                ...
                                codeString: OpenAttestationEthereumTokenRegistryMintedCode[OpenAttestationEthereumTokenRegistryMintedCode.UNEXPECTED_ERROR]
                            },
                            status: "ERROR"
                        }];
                case 3: return [2 /*return*/];
