...
import { isWrappedV3Document } from "../../types/core";
import { OpenAttestationEthereumDocumentStoreRevokedCode } from "../../types/error";
import { createDocumentStoreContract, getIssuersDocumentStore, isRevokedOnDocumentStore } from "../../common/smartContract/documentStoreContractInterface";
        ...
        switch (_a.label) {
            case 0:
                revokedStatusDeferred = intermediateHashes.map(function (hash) {
                    return isRevokedOnDocumentStore(smartContract, hash).then(function (status) { return (status ? hash : undefined); });
                });
...
export var openAttestationEthereumDocumentStoreRevoked = {
    skip: function () {
        return Promise.resolve({
            ...
            reason: {
                ...
                codeString: OpenAttestationEthereumDocumentStoreRevokedCode[OpenAttestationEthereumDocumentStoreRevokedCode.SKIPPED],
                    ...
                    return [4 /*yield*/, Promise.all(documentStores.map(function (documentStore) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        contract = createDocumentStoreContract(documentStore, options);
                                        intermediateHashes = getIntermediateHashes(targetHash_1, proofs_1);
                                        return [4 /*yield*/, isAnyHashRevoked(contract, intermediateHashes)];
                                    case 1:
                                        revokedHash = _a.sent();
                                        status = {
                                            revoked: !!revokedHash,
                                    ...
                                    case 2:
                                        e_2 = _a.sent();
                                        return [2 /*return*/, { revoked: true, address: documentStore, reason: getErrorReason(e_2, documentStore) }];
                ...
                case 2:
                    ...
                    return [2 /*return*/, {
                            ...
                            reason: {
                                ...
                                codeString: OpenAttestationEthereumDocumentStoreRevokedCode[OpenAttestationEthereumDocumentStoreRevokedCode.UNEXPECTED_ERROR]
                            },
                            status: "ERROR"
                        }];
                case 3: return [2 /*return*/];
