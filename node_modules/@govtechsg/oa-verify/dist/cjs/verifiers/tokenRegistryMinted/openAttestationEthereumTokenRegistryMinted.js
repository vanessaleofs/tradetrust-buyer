...
var tokenRegistryContractInterface_1 = require("../../common/smartContract/tokenRegistryContractInterface");
var errors_1 = require("./errors");
var name = "OpenAttestationEthereumTokenRegistryMinted";
var type = "DOCUMENT_STATUS";
exports.openAttestationEthereumTokenRegistryMinted = {
    skip: function () {
        return Promise.resolve({
            ...
            name: name,
            reason: {
                code: error_1.OpenAttestationEthereumTokenRegistryMintedCode.SKIPPED,
                codeString: error_1.OpenAttestationEthereumTokenRegistryMintedCode[error_1.OpenAttestationEthereumTokenRegistryMintedCode.SKIPPED],
    ...
    verify: function (document, options) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    tokenRegistries = tokenRegistryContractInterface_1.getIssuersTokenRegistry(document);
                    ...
                    return [4 /*yield*/, Promise.all(tokenRegistries.map(function (tokenRegistry) { return __awaiter(void 0, void 0, void 0, function () {
                            var contract, minted, status, e_2;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 2, , 3]);
                                        contract = tokenRegistryContractInterface_1.createTokenRegistryContract(tokenRegistry, options);
                                        return [4 /*yield*/, tokenRegistryContractInterface_1.isMintedOnTokenRegistry(contract, merkleRoot_1)];
                                    case 1:
                                        minted = _a.sent();
                                        status = {
                                            minted: minted,
                ...
                case 1:
                    ...
                    if (notMinted) {
                        return [2 /*return*/, {
                                name: name,
                                type: type,
                                data: { mintedOnAll: false, details: core_1.isWrappedV3Document(document) ? statuses[0] : statuses },
                    ...
                    return [2 /*return*/, {
                            name: name,
                            type: type,
                            data: { mintedOnAll: true, details: core_1.isWrappedV3Document(document) ? statuses[0] : statuses },
                            status: "VALID"
                        }];
                case 2:
                    e_1 = _a.sent();
                    return [2 /*return*/, {
                            ...
                            reason: {
                                message: e_1.message,
                                code: error_1.OpenAttestationEthereumTokenRegistryMintedCode.UNEXPECTED_ERROR,
                                codeString: error_1.OpenAttestationEthereumTokenRegistryMintedCode[error_1.OpenAttestationEthereumTokenRegistryMintedCode.UNEXPECTED_ERROR]
                            },
                            status: "ERROR"
                        }];
                case 3: return [2 /*return*/];
