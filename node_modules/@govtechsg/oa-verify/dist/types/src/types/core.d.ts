...
export declare const isWrappedV3Document: (document: any) => document is WrappedDocument<v3.OpenAttestationDocument>;
export declare const isWrappedV2Document: (document: any) => document is WrappedDocument<v2.OpenAttestationDocument>;
export {};
