export declare enum OpenAttestationEthereumDocumentStoreIssuedCode {
    UNEXPECTED_ERROR = 0,
...
export declare enum OpenAttestationEthereumDocumentStoreRevokedCode {
    UNEXPECTED_ERROR = 0,
    DOCUMENT_REVOKED = 1,
    CONTRACT_ADDRESS_INVALID = 2,
    ETHERS_UNHANDLED_ERROR = 3,
...
export declare enum OpenAttestationEthereumTokenRegistryMintedCode {
    UNEXPECTED_ERROR = 0,
