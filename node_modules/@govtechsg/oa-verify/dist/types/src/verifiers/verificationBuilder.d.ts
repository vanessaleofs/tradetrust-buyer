 ...
 */
export declare const verificationBuilder: <Document = WrappedDocument<v3.OpenAttestationDocument>>(verifiers: Verifier<Document, VerificationManagerOptions, any>[]) => (document: Document, options: VerificationManagerOptions) => Promise<VerificationFragment<any>[]>;
