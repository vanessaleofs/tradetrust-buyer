...
var getGlobals = function (sources, initialGlobals) {
    ...
    return (Array.isArray(sources) ? sources : Object.keys(sources)).reduce(function (globals, source) {
        var _a;
...
var getRemarkProcessor = function (searchFrom) {
    ...
    /* istanbul ignore next */
    var _a = remarkConfig.searchSync(searchFrom) || {}, config = _a.config, filepath = _a.filepath;
    /* istanbul ignore next */
